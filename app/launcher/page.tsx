...
export default function LauncherPage() {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-950/40 text-slate-100 flex flex-col items-center justify-start p-4 sm:p-8 selection:bg-sky-500/30 selection:text-sky-200">
